...
class MyPageBottomSheetAdapter : RecyclerView.Adapter<MyPageBottomSheetAdapter.MainViewHolder>(){
    ...
    class MainViewHolder(private val binding : MyPageCherryItemBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        ...
        val binding : MyPageCherryItemBinding = MyPageCherryItemBinding.inflate(layoutInflater,parent,false)
